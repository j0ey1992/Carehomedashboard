// Face-to-face training courses (manager to book/arrange)
export const F2F_COURSES = [
  'Basic Life Support',
  'Fire Drill (Days)',
  'Donning & Doffing Competency',
  'Fire Drill (Night Scenario)',
  'Dysphagia (Tier 2)',
  'MCA & DoLS (Level 2)',
  'BIR Specialism - Modules 4 & 5',
  'BIR Specialism - Modules 2 & 3',
  'BIR Specialism - Module 1',
  'Catheter Care',
  'Ligature',
  'Safety Interventions Disengagement',
  'Fire Safety for Leadership Teams',
...
// Staff training courses (e-learning)
...
// Courses that can be marked as complete directly
export const DIRECT_COMPLETION_COURSES = [
...
// Supervision courses
export const SUPERVISION_COURSES = [
  'Supervision',
  'Appraisal',
...
// Compliance courses (manager to do)
export const COMPLIANCE_COURSES = [
  'Emergency Scenario',
  'Medication - Competency'
];
